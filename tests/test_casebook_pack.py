"""Regression checks for the harbor-dev-refactor-guard casebook."""
...
from casebook.harness import assert_expected, harbor_dev_refactor_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_dev_refactor_guard_summary(), assert_expected())
