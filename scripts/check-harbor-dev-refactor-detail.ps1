...
$repo = "harbor-dev-refactor-guard"
$language = "Rust"
$category = "Developer tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/harbor-dev-refactor-walkthrough.md")) {
...
if ($profile.highest_case.name -ne "stress") { throw "$repo profile highest case changed" }
